...
use Chronopost\Controller\ChronopostRelayController;
use ErrorException;
...
class ChronopostGetRelay extends BaseLoop implements ArraySearchLoopInterface
{
    /**
     * @inheritdoc
     */
    ...
    public function buildArray()
    {
        ...
        $request = new ChronopostRelayController();
