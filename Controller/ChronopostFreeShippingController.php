...
use Chronopost\Form\ChronopostFreeShippingForm;
...
class ChronopostFreeShippingController extends BaseAdminController
{
    /**
    ...
    {
        if (null !== $response = $this->checkAuth(array(AdminResources::MODULE), array('Chronopost'), AccessManager::UPDATE)) {
            return $response;
        }

        $form = new ChronopostFreeShippingForm($this->getRequest());
        $response = null;
        ...
        try {
            ...
            $deliveryMode = ChronopostDeliveryModeQuery::create()->findOneById($deliveryModeId);
            $deliveryMode
    ...
    public function setFreeShippingFrom()
    {
        ...
        $deliveryMode = ChronopostDeliveryModeQuery::create()->findOneById($data->get('delivery-mode'));
    ...
    public function setAreaFreeShipping()
    {
        ...
        try {
            ...
            $deliveryModeQuery = ChronopostDeliveryModeQuery::create()->findOneById($chronopostDeliveryId);
            if (null === $deliveryModeQuery) {
                return null;
            }

            $chronopostFreeShipping = new ChronopostAreaFreeshipping();
            $chronopostFreeShippingQuery = ChronopostAreaFreeshippingQuery::create()
            ...
            $cartAmountQuery = ChronopostAreaFreeshippingQuery::create()
                ->filterByAreaId($chronopostAreaId)
                ->filterByDeliveryModeId($chronopostDeliveryId)
                ->findOneOrCreate()
                ->setCartAmount($cartAmount)
