...
abstract class ChronopostDeliveryMode implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Chronopost\\Model\\Map\\ChronopostDeliveryModeTableMap';
    ...
    /**
     * Initializes internal state of Chronopost\Model\Base\ChronopostDeliveryMode object.
     */
    ...
    /**
     * Compares this with another <code>ChronopostDeliveryMode</code> instance.  If
     * <code>obj</code> is an instance of <code>ChronopostDeliveryMode</code>, delegates to
     * <code>equals(ChronopostDeliveryMode)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ChronopostDeliveryMode The current object, for fluid interface
     */
     ...
     * @return   \Chronopost\Model\ChronopostDeliveryMode The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChronopostDeliveryModeTableMap::ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[ChronopostDeliveryModeTableMap::TITLE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[ChronopostDeliveryModeTableMap::CODE] = true;
        }
    ...
    public function setFreeshippingActive($v)
    {
        ...
        if ($this->freeshipping_active !== $v) {
            ...
            $this->modifiedColumns[ChronopostDeliveryModeTableMap::FREESHIPPING_ACTIVE] = true;
        }
    ...
    public function setFreeshippingFrom($v)
    {
        ...
        if ($this->freeshipping_from !== $v) {
            ...
            $this->modifiedColumns[ChronopostDeliveryModeTableMap::FREESHIPPING_FROM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChronopostDeliveryModeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChronopostDeliveryModeTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ChronopostDeliveryModeTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ChronopostDeliveryModeTableMap::translateFieldName('FreeshippingActive', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freeshipping_active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ChronopostDeliveryModeTableMap::translateFieldName('FreeshippingFrom', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = ChronopostDeliveryModeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Chronopost\Model\ChronopostDeliveryMode object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChronopostDeliveryModeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ChronopostDeliveryMode::setDeleted()
     * @see ChronopostDeliveryMode::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildChronopostDeliveryModeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChronopostDeliveryModeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ChronopostDeliveryModeTableMap::ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ChronopostDeliveryModeTableMap::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'TITLE';
        }
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::CODE)) {
            $modifiedColumns[':p' . $index++]  = 'CODE';
        }
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::FREESHIPPING_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = 'FREESHIPPING_ACTIVE';
        }
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::FREESHIPPING_FROM)) {
            $modifiedColumns[':p' . $index++]  = 'FREESHIPPING_FROM';
        }

        $sql = sprintf(
            'INSERT INTO chronopost_delivery_mode (%s) VALUES (%s)',
    ...
    {
        $pos = ChronopostDeliveryModeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ChronopostDeliveryMode'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ChronopostDeliveryMode'][$this->getPrimaryKey()] = true;
        $keys = ChronopostDeliveryModeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(ChronopostDeliveryModeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::ID)) $criteria->add(ChronopostDeliveryModeTableMap::ID, $this->id);
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::TITLE)) $criteria->add(ChronopostDeliveryModeTableMap::TITLE, $this->title);
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::CODE)) $criteria->add(ChronopostDeliveryModeTableMap::CODE, $this->code);
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::FREESHIPPING_ACTIVE)) $criteria->add(ChronopostDeliveryModeTableMap::FREESHIPPING_ACTIVE, $this->freeshipping_active);
        if ($this->isColumnModified(ChronopostDeliveryModeTableMap::FREESHIPPING_FROM)) $criteria->add(ChronopostDeliveryModeTableMap::FREESHIPPING_FROM, $this->freeshipping_from);
    ...
    {
        $criteria = new Criteria(ChronopostDeliveryModeTableMap::DATABASE_NAME);
        $criteria->add(ChronopostDeliveryModeTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Chronopost\Model\ChronopostDeliveryMode (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Chronopost\Model\ChronopostDeliveryMode Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildChronopostDeliveryMode is new, it will return
        ...
        if (null === $this->collChronopostPrices || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collChronopostPrices) {
                ...
                $collChronopostPrices = ChildChronopostPriceQuery::create(null, $criteria)
                    ->filterByChronopostDeliveryMode($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return   ChildChronopostDeliveryMode The current object (for fluent API support)
     */
    public function setChronopostPrices(Collection $chronopostPrices, ConnectionInterface $con = null)
    {
        ...
        foreach ($chronopostPricesToDelete as $chronopostPriceRemoved) {
            $chronopostPriceRemoved->setChronopostDeliveryMode(null);
        }
    ...
    protected function doAddChronopostPrice($chronopostPrice)
    {
        ...
        $chronopostPrice->setChronopostDeliveryMode($this);
    }
    ...
    public function removeChronopostPrice($chronopostPrice)
    {
        if ($this->getChronopostPrices()->contains($chronopostPrice)) {
            ...
            $chronopostPrice->setChronopostDeliveryMode(null);
        }
     ...
     * Otherwise if this ChronopostDeliveryMode is new, it will return
     * an empty collection; or if this ChronopostDeliveryMode has previously
     * been saved, it will retrieve related ChronopostPrices from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ChronopostDeliveryMode.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setChronopostAreaFreeshippings(Collection $chronopostAreaFreeshippings, ConnectionInterface $con = null)
    {
        ...
        foreach ($chronopostAreaFreeshippingsToDelete as $chronopostAreaFreeshippingRemoved) {
            $chronopostAreaFreeshippingRemoved->setChronopostDeliveryMode(null);
        }
    ...
    protected function doAddChronopostAreaFreeshipping($chronopostAreaFreeshipping)
    {
        ...
        $chronopostAreaFreeshipping->setChronopostDeliveryMode($this);
    }
    ...
    public function removeChronopostAreaFreeshipping($chronopostAreaFreeshipping)
    {
        if ($this->getChronopostAreaFreeshippings()->contains($chronopostAreaFreeshipping)) {
            ...
            $chronopostAreaFreeshipping->setChronopostDeliveryMode(null);
        }
    ...
    {
        return (string) $this->exportTo(ChronopostDeliveryModeTableMap::DEFAULT_STRING_FORMAT);
    }
