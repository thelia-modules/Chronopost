...
abstract class ChronopostAreaFreeshipping implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Chronopost\\Model\\Map\\ChronopostAreaFreeshippingTableMap';
    ...
    /**
     * Initializes internal state of Chronopost\Model\Base\ChronopostAreaFreeshipping object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ChronopostAreaFreeshipping</code> instance.  If
     * <code>obj</code> is an instance of <code>ChronopostAreaFreeshipping</code>, delegates to
     * <code>equals(ChronopostAreaFreeshipping)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return ChronopostAreaFreeshipping The current object, for fluid interface
     */
     ...
     * @return   \Chronopost\Model\ChronopostAreaFreeshipping The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChronopostAreaFreeshippingTableMap::ID] = true;
        }
    ...
    public function setAreaId($v)
    {
        ...
        if ($this->area_id !== $v) {
            $this->area_id = $v;
            $this->modifiedColumns[ChronopostAreaFreeshippingTableMap::AREA_ID] = true;
        }
    ...
    public function setDeliveryModeId($v)
    {
        ...
        if ($this->delivery_mode_id !== $v) {
            ...
            $this->modifiedColumns[ChronopostAreaFreeshippingTableMap::DELIVERY_MODE_ID] = true;
        }
    ...
    public function setCartAmount($v)
    {
        ...
        if ($this->cart_amount !== $v) {
            $this->cart_amount = $v;
            $this->modifiedColumns[ChronopostAreaFreeshippingTableMap::CART_AMOUNT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChronopostAreaFreeshippingTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChronopostAreaFreeshippingTableMap::translateFieldName('AreaId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->area_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ChronopostAreaFreeshippingTableMap::translateFieldName('DeliveryModeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->delivery_mode_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ChronopostAreaFreeshippingTableMap::translateFieldName('CartAmount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ChronopostAreaFreeshippingTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Chronopost\Model\ChronopostAreaFreeshipping object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChronopostAreaFreeshippingQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ChronopostAreaFreeshipping::setDeleted()
     * @see ChronopostAreaFreeshipping::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildChronopostAreaFreeshippingQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChronopostAreaFreeshippingTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::AREA_ID)) {
            $modifiedColumns[':p' . $index++]  = 'AREA_ID';
        }
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::DELIVERY_MODE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'DELIVERY_MODE_ID';
        }
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::CART_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'CART_AMOUNT';
        }

        $sql = sprintf(
            'INSERT INTO chronopost_area_freeshipping (%s) VALUES (%s)',
    ...
    {
        $pos = ChronopostAreaFreeshippingTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ChronopostAreaFreeshipping'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ChronopostAreaFreeshipping'][$this->getPrimaryKey()] = true;
        $keys = ChronopostAreaFreeshippingTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::ID)) $criteria->add(ChronopostAreaFreeshippingTableMap::ID, $this->id);
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::AREA_ID)) $criteria->add(ChronopostAreaFreeshippingTableMap::AREA_ID, $this->area_id);
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::DELIVERY_MODE_ID)) $criteria->add(ChronopostAreaFreeshippingTableMap::DELIVERY_MODE_ID, $this->delivery_mode_id);
        if ($this->isColumnModified(ChronopostAreaFreeshippingTableMap::CART_AMOUNT)) $criteria->add(ChronopostAreaFreeshippingTableMap::CART_AMOUNT, $this->cart_amount);
    ...
    {
        $criteria = new Criteria(ChronopostAreaFreeshippingTableMap::DATABASE_NAME);
        $criteria->add(ChronopostAreaFreeshippingTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Chronopost\Model\ChronopostAreaFreeshipping (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Chronopost\Model\ChronopostAreaFreeshipping Clone of current object.
     * @throws PropelException
     */
    ...
    public function setArea(ChildArea $v = null)
    {
        ...
        if ($v !== null) {
            $v->addChronopostAreaFreeshipping($this);
        }
    ...
    public function getArea(ConnectionInterface $con = null)
    {
        if ($this->aArea === null && ($this->area_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArea->addChronopostAreaFreeshippings($this);
             */
        }
    ...
    public function getChronopostDeliveryMode(ConnectionInterface $con = null)
    {
        if ($this->aChronopostDeliveryMode === null && ($this->delivery_mode_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aChronopostDeliveryMode->addChronopostAreaFreeshippings($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ChronopostAreaFreeshippingTableMap::DEFAULT_STRING_FORMAT);
    }
